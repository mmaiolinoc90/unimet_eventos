...
mysql_query("INSERT INTO evento_interno (titulo_evento,des_evento,cant_per,inst_aliada, financiamiento, fecha_solicitud, status, evento_img, usuario_interno_id_usuario_interno) VALUES ('$_POST[titulo]','$_POST[descripcion]','$_POST[cantidad]','$_POST[institucion_aliada]','$_POST[financiamiento]','".$fecha_sistema."','".$status."','".$nombre_archivo."', '$_POST[id_usuario]')",$conexion);
