        ...
        <div class="contenedor_interno">
                  ...
                  <div id="formulario_interno">
                    ...
                    <center>Formulario para evento interno</center>
                      ...
                      <p>&nbsp;</p>
                      <p>&nbsp;</p>
                      <form name="formulario_registro_evento_externo" method="post" id="registro" action="clases/resgistro_evento_externo.php"  enctype="multipart/form-data">
                      ...
                      <?php  
							...
							$nombre = mysql_query('SELECT * FROM usuario_externo WHERE correo="'.mysql_real_escape_string($correo).'"');  
							...
							while ($row = mysql_fetch_row($nombre)){
										echo ' <table width="600"  style="margin-left:200px"> ';  
											...
											echo "<tr>";  
												   echo '<td width="230"> Rif de Identidad:</td>';
												   echo "<td>$row[3]</td>";
											echo "</tr>";
